...
#define MAX_MERGE_NUM       10
#define EAST_STOP_LINE_X    14.0
#define WEST_STOP_LINE_X    -14.0
#define VEH_LENGTH          5.0
#define MAX_ACCEL           2.0
#define MAX_DECEL           3.0
...
protected:
    ...
    double TP = 3.5; // time-gap between two platoons
...
private:
    ...
    bool intersectionMerge = false;
    int originOptSize;
    bool accelRestore = false;
    bool optSizeRestore = false;
    double frontVehSpeed = 0;

    omnetpp::simsignal_t executeEachTS;
...
public:
    ...
    virtual void finish();
    void receiveSignal(omnetpp::cComponent* source, omnetpp::simsignal_t signalID, long i, cObject* details);
